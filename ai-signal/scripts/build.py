...
def home(data, version):
    ...
    description = "An independent editorial AI publication that separates verified facts, interpretation, uncertainty, and conditional outlook."
    if data["publication"]["mode"] == "demo":
        description = "An editorial AI publication. The launch edition contains clearly labeled fictional demonstrations, not current news."
    return header("What changed. Why it matters. Where it’s going.", description, "./", BASE, data, version) + f'''
